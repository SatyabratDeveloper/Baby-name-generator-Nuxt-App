...
<template>
  <div class="container">
    ...
    <div class="options-container">
      <Option v-for="option in optionsArray" :key="option" :option="option" :options="options" />
      <button class="primary" @click="computeSelectedNames">Find Names</button>
    </div>
    <div class="cards-container">
      <NameCard v-for="(name, index) in selectedNames" :key="name" :name="name" :index="index" @remove="() => removeName(index)" />
    </div>
  </div>
</template>
